<x-app-layout>
    <x-slot name="header">
        <h2 class="text-lg sm:text-xl font-semibold leading-tight">Edit Video</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('videos.update', $video) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <x-form.label value="Current Video" />
                    </div>
                    @if ($video->url)
                        <div class="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 max-w-md">
                    ...
                    @else
                        <p class="text-sm text-gray-500 dark:text-gray-400 italic">No video file or URL set.</p>
                    @endif
                </div>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    {{-- File upload --}}
                    <div>
                        <x-form.label for="video_file" value="Replace Video (Upload New)" />
                        <input
                            id="video_file"
                            name="video_file"
                            type="file"
                    ...
                    {{-- Video URL --}}
                    <div>
                        <x-form.label for="video_url" value="Replace with Video URL" />
                        <x-form.input
                            id="video_url"
                            name="video_url"
                            type="url"
                ...
                <div x-data="{
                    ...
                    selectedIds: {{ json_encode(array_map('intval', old('properties', $assignedPropertyIds))) }},
                    search: ''
                }" x-init="">
