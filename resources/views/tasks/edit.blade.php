            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select id="type" name="type"
                        ...
                        <option value="instructions" @selected(old('type', $task->type) === 'instructions')>Instructions Only (Informational block for staff)</option>
                    </select>
                ...
                {{-- Occasional Task --}}
                <div class="flex items-center gap-2 pt-6">
                    <x-form.checkbox id="is_sporadic" name="is_sporadic" value="1" :checked="old('is_sporadic', $task->is_sporadic)" />
                    <div>
